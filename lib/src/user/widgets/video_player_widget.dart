...
class _SimpleVideoPlayerState extends State<SimpleVideoPlayer> {
  ...
  Duration _duration = const Duration(seconds: 10); // Mock duration
  bool _notifiedCompletion =
      false; // Flag to prevent duplicate completion notifications
  ...
  void _simulateVideoProgress() {
    ...
    if (_position >= _duration && !_isCompleted) {
      _completeVideo();
      return;
    }
  ...
  void _completeVideo() {
    ...
    if (!_notifiedCompletion && widget.onVideoCompleted != null) {
