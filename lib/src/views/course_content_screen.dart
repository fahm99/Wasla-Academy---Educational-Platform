            ...
            ..._course!.exams.map((exam) {
              return ListTile(
                leading: Container(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                    color: exam.locked ? Colors.grey : AppColors.warning,
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: const Icon(
                    Icons.quiz,
                ...
                title: Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.w500,
                    color: exam.locked ? Colors.grey : Colors.black,
                  ),
                ),
                subtitle: Text(
                  ...
                  style: TextStyle(
                    fontSize: 14,
                    color: exam.locked ? Colors.grey[400] : Colors.grey,
                  ),
                ),
                trailing: Container(
                  padding:
                  ...
                  decoration: BoxDecoration(
                    color: exam.locked
                        ? Colors.grey[300]
                        : (exam.locked ? Colors.grey : AppColors.warning),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Text(
                    exam.locked ? 'مقفل' : 'متاح',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 12,
                    ),
